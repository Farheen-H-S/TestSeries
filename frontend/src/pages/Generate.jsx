              ...
              <div className="preview-stats">
                <div className="stats-section">
                  ...
                  <div className="stats-row">
                    ...
                    <div className={`stat-item ${module === 'RTP' ? 'stat-item-disabled' : ''}`}>
                      <span className="stat-value">{module === 'RTP' ? 'N/A' : preview.available_marks}</span>
                      <span className="stat-label">{module === 'RTP' ? 'Marks (N/A)' : 'Marks'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="stats-section">
                  ...
                  <div className="stats-row">
                    ...
                    <div className={`stat-item ${module === 'RTP' ? 'stat-item-disabled' : ''}`}>
                      <span className="stat-value">{module === 'RTP' ? 'N/A' : preview.selected_total_marks}</span>
                      <span className="stat-label">{module === 'RTP' ? 'Marks (N/A)' : 'Marks'}</span>
                    </div>
                  </div>
                  {module === 'RTP' ? (
                    <p className="stats-quality-hint">
                      RTP papers are generated by question count.
                    </p>
